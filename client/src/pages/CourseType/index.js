...
const CourseType = () => {
  ...
  return (
    <div className="page-container">
      <HeaderComponent title="课程类别管理" />
      <div className="body-wrap">
        <div className="header-wrap">
          <div className="search-box">
            <Input.Search placeholder="请输入课程类别名称" allowClear enterButton onSearch={value => setQuery(value)} />
          </div>
          <div className="operation-wrap">
            <Button type="primary" icon={<PlusOutlined />} onClick={showModal}>新增课程类别</Button>
      ...
      >
        <Form {...layout} form={form} name="control-hooks">
          <Form.Item name="name" label="课程类别" rules={[{ required: true }]}>
            <Input />
          </Form.Item>
        </Form>
      </Modal>
