...
const majorObject = '本专业培养面向行业和区域、适应经济和社会需要，具有社会责任感和职业素养，具有扎实的数学、自然科学、人文社会科学和软件工程专业基础知识，具有实践应用能力、自我获取知识能力、交流组织协同能力、跨文化沟通和创新意识，能对软件工程复杂问题进行分析和解决，根据需求提出系统解决方案，具有软件分析、设计、开发、测试、应用、维护等软件工程应用能力，能在软件工程以及相关领域从事软件系统分析研究、设计、开发、测试、应用以及管理维护等工作的应用技术型高级专门人才。'
